            ...
            optionData = void 0 !== optionData ? optionData : npt.getAttribute("data-inputmask-" + option),
                ...
                ("string" == typeof optionData &&
                    (0 === option.indexOf("on")
                        ...
                        : "false" === optionData ? optionData = !1 : "true" === optionData && (optionData = !0)),
    ...
    function generateMaskSet(opts, nocache) {
        function analyseMask(mask) {
            ...
            function defaultCase() {
                if (openenings.length > 0) {
                    if (currentOpeningToken = openenings[openenings
                            .length -
                            1], maskCurrentToken(m, currentOpeningToken, lastMatch, !currentOpeningToken.isAlternator),
            ...
            return currentToken.matches.length > 0 &&
                (lastMatch = currentToken.matches[currentToken.matches.length - 1],
                    verifyGroupMarker(lastMatch), maskTokens
                        .push(currentToken)), opts.numericInput && reverseTokens(maskTokens[0]),
                maskTokens;
        }
                ...
                return $.each(opts.numericInput ? opts.mask.reverse() : opts.mask,
                    function(ndx, msk) {
                        altMask
                            ...
                            1 &&
                            (altMask += ")|("), altMask +=
                            preProcessMask(void 0 === msk.mask || $.isFunction(msk.mask) ? msk : msk.mask);
    ...
    function maskScope(actionObj, maskset, opts) {
                ...
                baseOnInput === !0 && getMaskSet().validPositions[pos]
                        ? (testPos = getMaskSet().validPositions[pos],
                            test = testPos.match, ndxIntlzr = testPos.locator.slice(), maskTemplate
                                .push(includeInput === !0 ? testPos.input : getPlaceholder(pos, test)))
        ...
        function stripValidPositions(start, end, nocheck, strict) {
            ...
            for (resetMaskSet(!0), i = startPos + 1; i <= getLastValidPosition();) {
                ...
                if (i < startPos && (i = startPos + 1), void 0 === getMaskSet().validPositions[i] && isMask(i) ||
                    void 0 !== s) i++;
                else {
                ...
                (testPos = testPositions[ndx],
                    !(testPos.match &&
                        ...
                        (void 0 === lvTest.alternation ||
                            ...
                            void 0 !== testPos.locator[lvTest.alternation] && checkAlternationMatch(testPos.locator[lvTest.alternation].toString().split(","), lvTestAltArr))) ||
                            ...
                            if (altIndex === -1 || "string" == typeof altIndex) {
                                ...
                                for (var ndx = 0; ndx < altIndexArr.length; ndx++) {
                                    if (amndx = parseInt(altIndexArr[ndx]), matches = [], ndxInitializer =
                                            resolveNdxInitializer(testPos, amndx) || ndxInitializerClone.slice(),
                                        ...
                                        for (var ndx2 = 0; ndx2 < malternateMatches.length; ndx2++) {
                                            ...
                                            (altMatch.match.def === altMatch2.match.def ||
                                                ...
                                                hasMatch = altMatch.match
                                                    .mask ===
                                                    altMatch2.match.mask, altMatch2.locator[altMatch.alternation]
                                                    .toString()
                                                    .indexOf(altMatch.locator[altMatch.alternation]) ===
                                                    -1 &&
                                                    (altMatch2
                                                            .locator[altMatch.alternation] =
                ...
                for (pndx++; pndx < maskPos; pndx++)
                    ...
                    (testsFromPos = getTests(pndx, getTestTemplate(pndx - 1).locator, pndx - 1).slice(),
                        ...
                        (testTemplate.match.def === opts.radixPointDefinitionSymbol ||
                            !isMask(pndx, !0) ||
                            $.inArray(opts.radixPoint, getBuffer()) < pndx && testTemplate.match.fn && testTemplate.match.fn.test(getPlaceholder(pndx), getMaskSet(), pndx, !1, opts)) &&
        ...
        function patchValueProperty(npt) {
                    ...
                    $.valHooks[type] = {
                        get: function(elem) {
                            if (elem.inputmask) {
                                ...
                                return getLastValidPosition(void 0, void 0, elem.inputmask.maskset.validPositions) !==
                                    -1 ||
                                    opts.nullable !== !0
                                    ? result
                                    : "";
            ...
            function getter() {
                return this.inputmask
                    ...
                    ? (isRTL ? clearOptionalTail(getBuffer().slice()).reverse() : clearOptionalTail(getBuffer().slice())
                    ).join("")
                    : valueGet.call(this)
                    : ""
                    : valueGet.call(this);
                ...
                if (opts.keepStatic) {
                    ...
                    if (lastAlt > -1)
                        for (getMaskSet().p = seekNext(getLastValidPosition(-1, !0)); validInputs.length > 0;) {
                            var keypress = new $.Event("keypress");
                            keypress.which = validInputs.pop().charCodeAt(0), keypressEvent
        ...
        function keydownEvent(e) {
            ...
            opts.onKeyDown
                .call(this, e, getBuffer(), caret(input).begin, opts), ignorable = $.inArray(k, opts.ignorables) !== -1;
        }
        ...
        function keypressEvent(e, checkval, writeOut, strict, ndx) {
            ...
            if (k) {
                ...
                if (valResult !== !1 &&
                (resetMaskSet(!0), forwardPosition = void 0 !== valResult.caret
                        ? valResult.caret
            ...
            if (getBuffer().join("") !== inputValue) {
                ...
                if (inputValue = inputValue
                    ...
                    if (1 === inputChar.length) {
                        var keypress = new $.Event("keypress");
                        return keypress.which = inputChar.charCodeAt(0), keypressEvent
                                .call(input,
                                    keypress,
                                    !0,
                                    !0,
                            ...
                            default:
                                ...
                                if (clickPosition < lastPosition
                                    ...
                                    ("" !== placeholder &&
                                            ...
                                            !isMask(lastPosition, !0) && getTest(lastPosition).match.def === placeholder
                                        ) &&
        ...
        function initializeColorMask(input) {
            function charSize() {
                ...
                return e.style.visibility = "hidden", e.style
                        .whiteSpace = "nowrap", e.style.fontSize = computedStyle.fontSize,
                    e.style.fontFamily = computedStyle.fontFamily, e.innerHTML = "0", input.parentNode
                        .insertBefore(e, input.nextSibling),
                    width = e.offsetWidth, input.parentNode.removeChild(e), width;
            }

            function position() {
                colorMask.style.top = offset.top +
                        parseInt(computedStyle.borderTopWidth) +
                        parseInt(computedStyle.paddingTop) +
                        "px",
                    colorMask.style.left = offset.left +
                        parseInt(computedStyle.borderLeftWidth) +
                        parseInt(computedStyle.paddingLeft) +
                        "px",
                    colorMask.style.width = parseInt(computedStyle.width) -
                        (parseInt(computedStyle.paddingLeft) +
                            parseInt(computedStyle.paddingRight) +
                            parseInt(computedStyle.borderRightWidth)) +
                        "px",
                    colorMask.style.height = parseInt(computedStyle.height) -
                        (parseInt(computedStyle.paddingTop) +
            ...
            colorMask = document.createElement("div"), colorMask.style.position = "absolute",
                position(), colorMask.style.color = computedStyle
                    .color, colorMask.style.backgroundColor = computedStyle.backgroundColor,
                colorMask.style.fontSize = computedStyle.fontSize, colorMask.style.fontStyle = computedStyle.fontStyle,
                colorMask.style.fontFamily = computedStyle
                    .fontFamily, colorMask.style.letterSpacing = computedStyle.letterSpacing,
                    ...
                    .on("resize",
                        function(e) {
                            offset = $(input).position(), computedStyle = (input.ownerDocument.defaultView || window)
                                ...
                                position();
                        }), EventRuler.off(input, "mouseenter"), $(input.nextSibling)
                    .on("mouseenter",
                        function(e) {
        ...
        function mask(elem) {
            if (el = elem, $el = $(el), opts.showTooltip && (el.title = opts.tooltip || getMaskSet().mask),
                ...
                (el.dir = "ltr",
                    el.removeAttribute("dir"), el.inputmask
                        .isRTL = !0, isRTL = !0), opts.colorMask === !0 && initializeColorMask(el),
                android &&
                ...
                (EventRuler.on(el, "submit", submitEvent), EventRuler.on(el, "reset", resetEvent),
                    ...
                    EventRuler.on(el, "drop", pasteEvent), EventRuler.on(el, "cut", cutEvent), EventRuler
                        .on(el, "complete", opts.oncomplete),
                ...
                getBufferTemplate(), "" !== el.inputmask._valueGet() ||
            ...
            case "unmaskedvalue":
                return el = actionObj.el, void 0 !== el && void 0 !== el.inputmask
                        ...
                        : (valueBuffer = actionObj.value,
                            opts
                                .numericInput &&
                                (isRTL = !0), valueBuffer = ($.isFunction(opts.onBeforeMask)
                ...
                elems = elems.nodeName ? [elems] : elems, $.each(elems,
                    function(ndx, el) {
                        ...
                        (void 0 !== el.inputmask && el.inputmask.remove(), el.inputmask = new Inputmask(),
                            ...
                            el.inputmask.el = el, el.inputmask.maskset = maskset, el.inputmask.isRTL = !1, $
